...
class ParticlesSet(object):
    ...
    :param    color:         (default False) if true it's possible to set a color for each particle
    ...
    def __init__( self , size=1 , dim=3 , boundary=None ,
                 ...
                 log_X=False , log_V=False , log_max_size=0 , dtype=np.float64, color=False ):
        ...
        if not color:
            ...
            self.__color = np.zeros((size,4) , dtype=dtype )
        ...
        if self.__color is not None:
            self.__property_dict['color'] = self.__color
    ...
    def realloc( self , size , dim , boundary=None ,
                 label=False , mass=True , velocity=True , charge=False ,
                 log_X=False , log_V=False , log_max_size=0, color=False ):
        """
        ...
        self.__init__( size , dim , boundary , label , mass , velocity , charge , log_X , log_V , log_max_size, color )
    ...
    color = property(get_color, doc="return the reference to the color list")
